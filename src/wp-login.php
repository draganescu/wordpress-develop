...
switch ( $action ) {
	...
	case 'confirm_admin_email':
		...
		*/
		...
		login_header( __( 'Confirm your admin email' ), '<p class="message">' . __( 'Please confirm or update your admin email' ) . '</p>', $errors );
		?>
		...
		<p>
			<label for="admin_email" ><?php _e( 'Your current admin email is:' ); ?><br />
			<input type="text" name="admin_email" id="user_login" class="input" value="<?php echo esc_attr( $admin_email ); ?>" size="20" autocapitalize="off" /></label>
		</p>
		<?php
			/**
		...
		<p class="submit"><input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="<?php esc_attr_e( 'Confirm or update admin email' ); ?>" /></p>
		<br />
		...
		<p class="admin-email__details">
			<?php
				_e( 'WordPress uses the admin email setting to send important system updates and notifications, such as the recovery link if you ever find yourself locked out of the WordPress Admin' );
			?>
		</p>
			<p class="admin-email__details">
